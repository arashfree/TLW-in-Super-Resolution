...
def parse_opt(known=False):
    ...
    parser.add_argument('--folder', type=str, default=r'D:\Arash\Jetco\my\SRDataset\SR_testing_datasets/', help='models path')
    parser.add_argument('--modelpath',type=str,default=r'D:\Arash\Jetco\my\TLW-in-Super-Resolution-main\TLW-in-Super-Resolution-main\compare_unc_step2_1epoch/')
