    ...
    for epoch in range(startepoch, maxepoch):
        ...
        for key in models.keys():
            if valid_result[key]['LPIPS-vgg'] < best_lpips[key]:
                ...
                torch.save(models[key].state_dict(), opt.modelpath +'SRModel'+key+'_best.pth')
                if wmodels[key] is not None:
...
def parse_opt(known=False):
    ...
    parser.add_argument('--trainpath', type=str, default='SRDataset/SR_training_datasets/'
                        , help='train dataset path')
    parser.add_argument('--valpath', type=str, default='SRDataset/SR_testing_datasets/Set5/',
                        help='validation dataset path')
    parser.add_argument('--startepoch', type=int, default=0)
    parser.add_argument('--endepoch', type=int, default=100)
    parser.add_argument('--batchsize', type=int, default=1)
    parser.add_argument('--modelpath', type=str, default='Checkpoints/L1_MSE_L1TLW_MSETLW/EDSRx4/', help='models path')
